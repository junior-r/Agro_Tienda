...
class ProductoForm(forms.ModelForm):
    ...
    descuento1 = forms.DecimalField(max_digits=10, decimal_places=2, widget=forms.NumberInput(attrs={'class': 'form-control'}), label='Precio de Descuento 1', required=False)
    descuento2 = forms.DecimalField(max_digits=10, decimal_places=2, widget=forms.NumberInput(attrs={'class': 'form-control'}), label='Precio de Descuento 2', required=False)
    descuento3 = forms.DecimalField(max_digits=10, decimal_places=2, widget=forms.NumberInput(attrs={'class': 'form-control'}), label='Precio de Descuento 3', required=False)

    first_number_range_1 = forms.IntegerField(widget=forms.NumberInput(attrs={'class': 'form-control'}), label='Número inicial del rango 1', required=False)
    last_number_range_1 = forms.IntegerField(widget=forms.NumberInput(attrs={'class': 'form-control'}), label='Número límite del rango 1', required=False)
    first_number_range_2 = forms.IntegerField(widget=forms.NumberInput(attrs={'class': 'form-control'}), label='Número inicial del rango 2', required=False)
    last_number_range_2 = forms.IntegerField(widget=forms.NumberInput(attrs={'class': 'form-control'}), label='Número límite del rango 2', required=False)
    first_number_range_3 = forms.IntegerField(widget=forms.NumberInput(attrs={'class': 'form-control'}), label='Número inicial del rango 3', required=False)
