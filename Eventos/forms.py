...
class EventoForm(forms.ModelForm):
    ...
    texto_boton = forms.CharField(max_length=100, widget=forms.URLInput(attrs={'class': 'form-control'}), label='Texto del botón')
    link = forms.CharField(max_length=300, widget=forms.TextInput(attrs={'class': 'form-control'}), label='Link de redirección')
